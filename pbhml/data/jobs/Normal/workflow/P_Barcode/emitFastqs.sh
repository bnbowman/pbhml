...
# createdAt       : 2014-09-16 17:11:58.195239
# createdAt (UTC) : 2014-09-17 00:11:58.195260
# ncmds           : 4
# LogPath         : /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/log/P_Barcode/emitFastqs.log
# Script Path     : /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/workflow/P_Barcode/emitFastqs.sh
...
# Output      : /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/data/barcoded-fastqs.tgz
#
########### END TASK metadata #############

cd /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/log/P_Barcode
# Writing to log file
cat /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/workflow/P_Barcode/emitFastqs.sh >> /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/log/P_Barcode/emitFastqs.log;
...
# Task 1
mkdir -p /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/data/barcoded-fastqs || exit $?
echo "Task 1 completed at $(date)"
# Task 2
pbbarcode emitFastqs --minAvgBarcodeScore 11  --subreads  --outDir /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/data/barcoded-fastqs /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/input.fofn /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/data/barcode.fofn || exit $?
echo "Task 2 completed at $(date)"
# Task 3
pushd /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/data/barcoded-fastqs && tar czf ../barcoded-fastqs.tgz *.fastq && popd || exit $?
echo "Task 3 completed at $(date)"
# Task 4
rm -rf /home/UNIXHOME/bbowman/2014/09/HLA_Hackathon/Normal_11/data/barcoded-fastqs || exit $?
